      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Submit Proposal for Approval</CardTitle>
              <CardDescription>
                Select team members who need to approve this proposal before it goes to the client
              </CardDescription>
            </div>
        ...
        <CardContent className="space-y-6">
              ...
              <label className="flex items-center space-x-2 cursor-pointer p-3 border rounded hover:bg-gray-50">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Every selected team member must approve before sending to client
                  </p>
                </div>
              </label>
              <label className="flex items-center space-x-2 cursor-pointer p-3 border rounded hover:bg-gray-50">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Choose which team members should review and approve this proposal
            </p>
            {loading ? (
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded">
            <p className="text-sm text-gray-700">
              ...
              The proposal will be sent directly to the client for approval.
            </p>
          </div>

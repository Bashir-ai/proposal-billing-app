...
<<<<<<< HEAD
            ...
            {proposal.type === "HOURLY" && proposal.hourlyRateTableType === "HOURLY_TABLE" && proposal.hourlyRateTableRates && (
              <div>
                <p className="text-sm font-medium text-gray-700 mb-3">Hourly Rates by Profile</p>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {(() => {
                        ...
                        return profileOrder
                          ...
                          .map(profile => (
                            <tr key={profile}>
                              <td className="px-4 py-3 text-sm text-gray-900">{profileLabels[profile] || profile}</td>
                              <td className="px-4 py-3 text-sm text-right font-medium text-gray-900">
                                {proposal.currencySymbol}{rates[profile].toFixed(2)}/hr
                              </td>
                            </tr>
                          ))
                      })()}
            ...
            {/* Estimate Message for HOURLY proposals */}
            {proposal.type === "HOURLY" && proposal.hourlyIsEstimate && (
              <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  <AlertCircle className="w-5 h-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-sm font-semibold text-yellow-900 mb-1">Estimated Fees</p>

...
export function ResubmitModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const endpoint = itemType === "proposal" 
        ? `/api/proposals/${itemId}/resubmit`
        : `/api/bills/${itemId}/resubmit`
      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Select new team members who need to approve this {itemType}
              </CardDescription>
            </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Choose which team members should review and approve this {itemType}
            </p>
            {loading ? (
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded">
            <p className="text-sm text-gray-700">
              <strong>Note:</strong> Resubmitting will reset all existing approvals and create new approval records for the selected team members.
            </p>
          </div>

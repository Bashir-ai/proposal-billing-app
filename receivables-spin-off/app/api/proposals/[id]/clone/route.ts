  ...
  try {
    ...
    const clonedProposal = await prisma.proposal.create({
      data: {
        ...
        retainerHoursPerMonth: options.copyBillingMethod ? originalProposal.retainerHoursPerMonth : null,
        retainerAdditionalHoursType: options.copyBillingMethod ? originalProposal.retainerAdditionalHoursType : null,
        retainerAdditionalHoursRate: options.copyBillingMethod ? originalProposal.retainerAdditionalHoursRate : null,
        retainerAdditionalHoursRateMin: options.copyBillingMethod ? originalProposal.retainerAdditionalHoursRateMin : null,
        retainerAdditionalHoursRateMax: options.copyBillingMethod ? originalProposal.retainerAdditionalHoursRateMax : null,
        retainerAdditionalHoursBlendedRate: options.copyBillingMethod ? originalProposal.retainerAdditionalHoursBlendedRate : null,
        ...
        successFeeBaseType: options.copyBillingMethod ? originalProposal.successFeeBaseType : null,
        successFeeBaseAmount: options.copyBillingMethod ? originalProposal.successFeeBaseAmount : null,
        successFeeBaseHourlyRate: options.copyBillingMethod ? originalProposal.successFeeBaseHourlyRate : null,
        successFeeBaseHourlyDescription: options.copyBillingMethod ? originalProposal.successFeeBaseHourlyDescription : null,
        successFeeType: options.copyBillingMethod ? originalProposal.successFeeType : null,
        hourlyIsEstimate: options.copyBillingMethod ? originalProposal.hourlyIsEstimate : false,
        hourlyIsCapped: options.copyBillingMethod ? originalProposal.hourlyIsCapped : false,

...
import { IssueRecurringInvoiceDraftsButton } from "@/components/proposals/IssueRecurringInvoiceDraftsButton"
                  ...
                  <table className="min-w-full border border-gray-200">
                    <thead>
                      <tr className="bg-gray-50">
                        <th className="px-4 py-2 text-left text-sm font-semibold text-gray-700 border-b">Profile</th>
                        <th className="px-4 py-2 text-right text-sm font-semibold text-gray-700 border-b">Rate</th>
                      </tr>
                    </thead>
                    <tbody>
                      {(() => {
                        ...
                        return profileOrder
                          ...
                          .map(profile => (
                            <tr key={profile} className="border-b hover:bg-gray-50">
                              <td className="px-4 py-2 text-sm text-gray-900">
                                {profile === "SECRETARIAT" ? "Secretariat" :
                                 profile === "TRAINEE" ? "Trainee" :
                                 profile === "JUNIOR_LAWYER" ? "Junior Lawyer" :
                                 profile === "LAWYER" ? "Lawyer" :
                                 profile === "SENIOR_LAWYER" ? "Senior Lawyer" :
                                 profile === "PARTNER" ? "Partner" : profile}
                              </td>
                              <td className="px-4 py-2 text-sm text-right font-medium text-gray-900">
                                {currencySymbol}{rates[profile].toFixed(2)}/hr
                              </td>
                            </tr>
                          ))
                      })()}
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-3">
              ...
              {/* Issue Recurring Invoice Drafts Button */}
              {proposal.status === ProposalStatus.APPROVED &&
                (proposal.recurringEnabled ||
                  proposal.items.some(
                    (item) => item.billingMethod === "RECURRING" && item.recurringEnabled
                  )) && (
                <IssueRecurringInvoiceDraftsButton proposalId={proposal.id} />
              )}

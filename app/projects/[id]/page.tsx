...
import { ProjectChargesSection } from "@/components/projects/ProjectChargesSection"
import { GenerateInvoiceButton } from "@/components/projects/GenerateInvoiceButton"
  ...
  return (
    <div>
      ...
      <GenerateInvoiceButton
        projectId={project.id}
        unbilledTimesheetAmount={unbilledTimesheetAmount}
        unbilledChargesAmount={unbilledChargesAmount}
        currency={project.currency}
      />
      ...
      {/* Todos Section */}
      <ProjectTodosSection projectId={project.id} />
